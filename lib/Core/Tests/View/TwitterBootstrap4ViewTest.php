...
<ul class="pagination">
    <li class="page-item prev"><a class="page-link" href="|9|" rel="prev">Previous</a></li>
    ...
    <li class="page-item next"><a class="page-link" href="|11|" rel="next">Next</a></li>
</ul>
EOF
    ...
    public function testRenderFirstPage(): void
    {
        ...
        $this->assertRenderedView(<<<EOF
<ul class="pagination">
    <li class="page-item prev disabled"><span class="page-link">Previous</span></li>
    ...
    <li class="page-item disabled"><span class="page-link">&hellip;</span></li>
    <li class="page-item"><a class="page-link" href="|100|">100</a></li>
    <li class="page-item next"><a class="page-link" href="|2|" rel="next">Next</a></li>
</ul>
EOF
            , $this->renderView($options));
    }
    ...
    public function testRenderLastPage(): void
    {
        ...
        $this->assertRenderedView(<<<EOF
<ul class="pagination">
    <li class="page-item prev"><a class="page-link" href="|99|" rel="prev">Previous</a></li>
    <li class="page-item"><a class="page-link" href="|1|">1</a></li>
    <li class="page-item disabled"><span class="page-link">&hellip;</span></li>
...
EOF
    ...
    public function testRenderWhenStartProximityIs2(): void
    {
        ...
        $this->assertRenderedView(<<<EOF
<ul class="pagination">
    <li class="page-item prev"><a class="page-link" href="|3|" rel="prev">Previous</a></li>
    <li class="page-item"><a class="page-link" href="|1|">1</a></li>
    <li class="page-item"><a class="page-link" href="|2|">2</a></li>
    <li class="page-item"><a class="page-link" href="|3|">3</a></li>
    ...
    <li class="page-item disabled"><span class="page-link">&hellip;</span></li>
    <li class="page-item"><a class="page-link" href="|100|">100</a></li>
    <li class="page-item next"><a class="page-link" href="|5|" rel="next">Next</a></li>
</ul>
EOF
            , $this->renderView($options));
    }
    ...
    public function testRenderWhenStartProximityIs3(): void
    {
        ...
        $this->assertRenderedView(<<<EOF
<ul class="pagination">
    <li class="page-item prev"><a class="page-link" href="|4|" rel="prev">Previous</a></li>
    <li class="page-item"><a class="page-link" href="|1|">1</a></li>
    <li class="page-item"><a class="page-link" href="|2|">2</a></li>
    <li class="page-item"><a class="page-link" href="|3|">3</a></li>
    <li class="page-item"><a class="page-link" href="|4|">4</a></li>
    ...
    <li class="page-item disabled"><span class="page-link">&hellip;</span></li>
    <li class="page-item"><a class="page-link" href="|100|">100</a></li>
    <li class="page-item next"><a class="page-link" href="|6|" rel="next">Next</a></li>
</ul>
EOF
            , $this->renderView($options));
    }
    ...
    public function testRenderWhenEndProximityIs2FromLast(): void
    {
        ...
        $this->assertRenderedView(<<<EOF
<ul class="pagination">
    <li class="page-item prev"><a class="page-link" href="|96|" rel="prev">Previous</a></li>
    <li class="page-item"><a class="page-link" href="|1|">1</a></li>
    <li class="page-item disabled"><span class="page-link">&hellip;</span></li>
    <li class="page-item"><a class="page-link" href="|94|">94</a></li>
    <li class="page-item"><a class="page-link" href="|95|">95</a></li>
    ...
    <li class="page-item"><a class="page-link" href="|99|">99</a></li>
    <li class="page-item"><a class="page-link" href="|100|">100</a></li>
    <li class="page-item next"><a class="page-link" href="|98|" rel="next">Next</a></li>
</ul>
EOF
            , $this->renderView($options));
    }
    ...
    public function testRenderWhenEndProximityIs3FromLast(): void
    {
        ...
        $this->assertRenderedView(<<<EOF
<ul class="pagination">
    <li class="page-item prev"><a class="page-link" href="|95|" rel="prev">Previous</a></li>
    <li class="page-item"><a class="page-link" href="|1|">1</a></li>
    <li class="page-item disabled"><span class="page-link">&hellip;</span></li>
    ...
    <li class="page-item"><a class="page-link" href="|99|">99</a></li>
    <li class="page-item"><a class="page-link" href="|100|">100</a></li>
    <li class="page-item next"><a class="page-link" href="|97|" rel="next">Next</a></li>
</ul>
EOF
            , $this->renderView($options));
    }
