...
use Pagerfanta\DoctrineDBAL\SingleTableQueryAdapter;
 ...
 *
 * @deprecated to be removed in 3.0, use the `Pagerfanta\DoctrineDBAL\SingleTableQueryAdapter` from the `pagerfanta/doctrine-dbal-adapter` package instead
 */
