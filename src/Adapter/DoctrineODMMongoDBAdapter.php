...
use Pagerfanta\DoctrineMongoDBODM\QueryAdapter;
 ...
 *
 * @deprecated to be removed in 3.0, use the `Pagerfanta\DoctrineMongoDBODM\QueryAdapter` from the `pagerfanta/doctrine-mongodb-odm-adapter` package instead
 */
